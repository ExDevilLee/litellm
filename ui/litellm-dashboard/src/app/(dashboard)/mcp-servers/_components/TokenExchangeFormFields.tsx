  ...
  return (
    <>
      ...
      <Form.Item
        ...
        rules={[{ required: !isEditing, message: t("Client ID is required for token exchange") }]}
      >
      ...
      <Form.Item
        ...
        rules={[{ required: !isEditing, message: t("Client Secret is required for token exchange") }]}
      >
            ...
            <>
                ...
                rules={
                  isEntraObo
                    ? [
                        {
                          required: true,
                          message: t("Microsoft Entra OBO requires a scope, e.g. api://<app-id>/.default"),
                        },
                      ]
                    : []
                }
              >
                <Select
                  mode="tags"
                  tokenSeparators={[","]}
                  placeholder={isEntraObo ? "api://<app-id>/.default" : t("Add scopes")}
