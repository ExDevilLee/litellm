  ...
  return (
    ...
    >
      ...
      <div className="overflow-y-auto px-4 pb-4">
        {loading ? (
          <div className="space-y-3" role="status" aria-label={t("Loading version history")}>
          ...
          <div className="text-center py-8 text-muted-foreground">{t("No version history available.")}</div>
        ) : (
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    ...
                    {isSelected && <Badge variant="secondary">{t("Active")}</Badge>}
                  </div>
