...
export default function AgentBuilderView({
  ...
  const handleDeleteAgent = () => {
    ...
    Modal.confirm({
      ...
      content: t('Are you sure you want to delete "{0}"? This cannot be undone.', selectedAgent.model_name),
      okText: t("Delete"),
      okType: "danger",
      cancelText: t("Cancel"),
      onOk: async () => {
  ...
  if (!accessToken || !userID || !userRole) {
    return (
      <div className="flex h-full items-center justify-center p-8 text-gray-500">
        {t("Sign in to use Agent Builder.")}
      </div>
    );
  }
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-60 shrink-0 border-r border-gray-200 bg-white flex flex-col">
          <div className="flex items-center justify-between border-b border-gray-200 p-3">
            ...
            <Button type="text" size="small" icon={<PlusOutlined />} onClick={handleAddAgent} aria-label={t("Add agent")} />
          </div>
          <div className="flex-1 overflow-y-auto p-2">
            {loadingAgents ? (
              ...
              <>
                ...
                >
                  <PlusOutlined className="mr-1" /> {t("New agent")}
                </button>
              </>
            )}
          </div>
              ...
              <Tabs
                ...
                items={[
                  ...
                  },
                  {
                    ...
                    label: (
                      <span>
                        <ExperimentOutlined className="mr-1" /> {t("Batch Test")}
                      </span>
                    ),
                    disabled: isNewAgent,
                    children: (
