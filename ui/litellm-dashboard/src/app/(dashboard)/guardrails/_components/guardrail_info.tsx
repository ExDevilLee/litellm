            ...
            <Grid numItems={1} numItemsSm={2} numItemsLg={3} className="gap-6">
              ...
              <Card>
                ...
                <div className="mt-2">
                  ...
                  <Text>{t("Last Updated: {0}", formatDate(guardrailData.updated_at))}</Text>
                </div>
              </Card>
            </Grid>
              ...
              Object.keys(guardrailData.litellm_params.pii_entities_config).length > 0 && (
                <Card className="mt-6">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge color="blue">
                      {t("{0} PII entities configured", Object.keys(guardrailData.litellm_params.pii_entities_config).length)}
                    </Badge>
                  </div>
                </Card>
              )}
              ...
              <Card className="mt-6">
                <div className="flex justify-between items-center mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <Text className="font-medium text-lg">{t("Custom Code")}</Text>
                  </div>
              ...
              <Card>
                ...
                {isEditing ? (
                  ...
                  >
                    ...
                    >
                      <Input placeholder={t("Enter guardrail name")} />
                    </Form.Item>
                  ...
                  <div className="space-y-4">
                    <div>
                      <Text className="font-medium">{t("Guardrail ID")}</Text>
