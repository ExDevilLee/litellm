...
const CostTrackingSettings: React.FC<CostTrackingSettingsProps> = ({ userID, userRole, accessToken }) => {
  ...
  const handleRemoveProvider = async (provider: string, providerDisplayName: string) => {
    modal.confirm({
      ...
      content: t("Are you sure you want to remove the discount for {0}?", providerDisplayName),
      okText: t("Remove"),
      okType: "danger",
      cancelText: t("Cancel"),
  ...
  const handleRemoveMargin = async (provider: string, providerDisplayName: string) => {
    modal.confirm({
      ...
      icon: <ExclamationCircleOutlined />,
      content: t("Are you sure you want to remove the margin for {0}?", providerDisplayName),
      okText: t("Remove"),
      okType: "danger",
      cancelText: t("Cancel"),
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
        <div>
          <div className="flex items-center gap-2">
            ...
            <DocsMenu items={DOCS_LINKS.map((item) => ({ ...item, label: t(item.label) }))} />
          </div>
              ...
              <div className="p-6">
                ...
                {isFetching ? (
                  ...
                  <div className="py-16 px-6 text-center">
                    ...
                    <Text className="text-gray-700 font-medium mb-2">{t("No provider margins configured")}</Text>
                    <Text className="text-gray-500 text-sm">
