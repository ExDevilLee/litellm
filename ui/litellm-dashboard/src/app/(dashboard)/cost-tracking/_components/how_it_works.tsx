...
const HowItWorks: React.FC = () => {
  ...
  return (
    <div className="space-y-4 pt-2">
      ...
      <div>
        ...
        <Text className="text-xs text-gray-600">{t("Discount percentages must be between 0% and 100%")}</Text>
      </div>
  ...
  -d '{
    ...
    "messages": [{"role": "user", "content": "Hello"}]
        ...
        />
        <Text className="text-xs text-gray-600 mt-3 mb-2">{t("Look for these headers in the response:")}</Text>
