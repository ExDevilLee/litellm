...
export const OrgCreateDialog = ({
  ...
  const mutation = useMutation({
    ...
    onError: (error: unknown) =>
      NotificationsManager.fromBackend(error instanceof Error ? error.message : t("Failed to create organization")),
  });
        ...
        <form onSubmit={onSubmit} noValidate>
          ...
          <DialogFooter className="mt-6">
            ...
            <Button type="submit" disabled={mutation.isPending}>
              {mutation.isPending ? t("Creating...") : t("Create Organization")}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
