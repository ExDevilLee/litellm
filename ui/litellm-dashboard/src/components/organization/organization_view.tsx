          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <Card>
              <CardContent>
                ...
                <div className="mt-2 text-sm text-foreground">
                  <p>{t("Created: {0}", new Date(orgData.created_at).toLocaleDateString())}</p>
                  <p>{t("Updated: {0}", new Date(orgData.updated_at).toLocaleDateString())}</p>
                  <p>{t("Created By: {0}", orgData.created_by)}</p>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="mt-2 text-sm text-foreground">
                  ...
                  {orgData.litellm_budget_table.budget_duration && (
                    <p className="text-muted-foreground">
                      {t("Reset: {0}", orgData.litellm_budget_table.budget_duration)}
                    </p>
                  )}
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent>
                ...
                <div className="mt-2 text-sm text-foreground">
                  <p>{t("TPM: {0}", orgData.litellm_budget_table.tpm_limit || t("Unlimited"))}</p>
                  <p>{t("RPM: {0}", orgData.litellm_budget_table.rpm_limit || t("Unlimited"))}</p>
                  {orgData.litellm_budget_table.max_parallel_requests && (
                    <p>{t("Max Parallel Requests: {0}", orgData.litellm_budget_table.max_parallel_requests)}</p>
                  )}
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent keepMounted={hasVisited("members")} value="members" className="pt-4">
          <div className="space-y-4">
            <MemberTable
              ...
              roleColumnTitle={t("Organization Role")}
              ...
              {isEditing ? (
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div>
                    ...
                    <div>{t("TPM: {0}", orgData.litellm_budget_table.tpm_limit || t("Unlimited"))}</div>
                    <div>{t("RPM: {0}", orgData.litellm_budget_table.rpm_limit || t("Unlimited"))}</div>
                  </div>
                  <div>
                    ...
                    <div>{t("Reset: {0}", orgData.litellm_budget_table.budget_duration || t("Never"))}</div>
                  </div>
