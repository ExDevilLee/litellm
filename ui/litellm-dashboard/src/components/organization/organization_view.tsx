          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <Card>
              <CardContent>
                ...
                <div className="mt-2 text-sm text-foreground">
                  <p>
                    {t("Created")}: {new Date(orgData.created_at).toLocaleDateString()}
                  </p>
                  <p>
                    {t("Updated")}: {new Date(orgData.updated_at).toLocaleDateString()}
                  </p>
                  <p>
                    {t("Created By")}: {orgData.created_by}
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="mt-2 text-sm text-foreground">
                  ...
                  {orgData.litellm_budget_table.budget_duration && (
                    <p className="text-muted-foreground">
                      {t("Reset")}: {orgData.litellm_budget_table.budget_duration}
                    </p>
                  )}
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent>
                ...
                <div className="mt-2 text-sm text-foreground">
                  <p>
                    {t("TPM")}: {orgData.litellm_budget_table.tpm_limit || t("Unlimited")}
                  </p>
                  <p>
                    {t("RPM")}: {orgData.litellm_budget_table.rpm_limit || t("Unlimited")}
                  </p>
                  {orgData.litellm_budget_table.max_parallel_requests && (
                    <p>
                      {t("Max Parallel Requests")}: {orgData.litellm_budget_table.max_parallel_requests}
                    </p>
                  )}
                </div>
              </CardContent>
              ...
              {isEditing ? (
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div>
                    ...
                    <div>
                      {t("Reset")}: {orgData.litellm_budget_table.budget_duration || t("Never")}
                    </div>
                  </div>
