            ...
            <>
              ...
              <Form.Item
                label={
                  <span>
                    {t("Models")}{" "}
                    <Tooltip title={t("These are the models that your selected team has access to. Leave empty to grant no models directly, e.g. when the team gets its models from access groups")}>
                      <InfoCircleOutlined style={{ marginLeft: "4px" }} />
                    </Tooltip>
                  </span>
                }
              ...
              <Form.Item
                label={t("Metadata")}
                help={t('Values are saved as text. Enter JSON for typed values, e.g. 3, true, or {"region": "us"}.')}
              >
                ...
                <AccordionBody>
                  ...
                  {canViewPolicies && (
                    <Form.Item
                      label={
                        <span>
                          {t("Policies")}{" "}
                          <Tooltip title={t("Apply policies to this team to control guardrails and other settings")}>
                            <a
                      ...
                      name="policies"
                      className="mt-8"
                      help={t("Select existing policies or enter new ones")}
                    >
                      <Select
                        mode="tags"
                        style={{ width: "100%" }}
                  ...
                  <Form.Item
                    label={
                      <span>
                        {t("Access Groups")}{" "}
                        <Tooltip title={t("Assign access groups to this team. Access groups control which models, MCP servers, and agents this team can use")}>
                          <InfoCircleOutlined style={{ marginLeft: "4px" }} />
                        </Tooltip>
                      </span>
                    }
                    ...
                    className="mt-8"
                    help={t("Select access groups to assign to this team")}
                  >
                  ...
                  <Form.Item
                    label={t("Allowed Pass Through Routes")}
                  ...
                  <Form.Item
                    label={
                      <span>
                        ...
                        <Tooltip title={t("Select which search tools this team can access. Leave empty to allow all search tools.")}>
                          <InfoCircleOutlined style={{ marginLeft: "4px" }} />
                        </Tooltip>
                      </span>
                    }
                    ...
                    className="mt-4"
                    help={t("Restrict which configured search tools keys on this team may call.")}
                  >
                    <SearchToolSelector
