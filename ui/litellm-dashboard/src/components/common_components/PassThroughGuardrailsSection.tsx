        ...
        description={
          <div className="space-y-2">
            ...
            <div className="text-xs space-y-1 mt-2">
              ...
              <div>
                • <code className="bg-gray-100 px-1 rounded-sm">query</code> - {t("Single field")}
              </div>
              <div>
                • <code className="bg-gray-100 px-1 rounded-sm">documents[*].text</code> - {t("All text in documents array")}
              </div>
              <div>
                • <code className="bg-gray-100 px-1 rounded-sm">messages[*].content</code> - {t("All message contents")}
              </div>
            </div>
          </div>
        }
      ...
      {selectedGuardrails.length > 0 && (
        <div className="mt-6 space-y-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-xs text-gray-500">{t("💡 Tip: Leave empty to check entire payload")}</div>
          </div>
